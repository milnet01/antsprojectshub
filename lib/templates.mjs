...
// data:. NOTE: frame-ancestors is ignored when delivered via <meta> (header-only) — it
// is kept for completeness but provides no active clickjacking protection here.
const CSP = [
  "default-src 'self'",
  "script-src 'self'",
  "style-src 'self'",
